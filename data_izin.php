...
// Koneksi ke database (ubah dengan kredensial database Anda)
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th>Alasan</th>
                <th>Tanggal Izin</th>
                <th>Aksi</th> <!-- Kolom aksi Update dan Delete -->
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            if ($result && $result->num_rows > 0) {
                ...
                echo "<tr><td colspan='6' class='text-center'>Tidak ada data izin mahasiswa yang tersedia.</td></tr>";
            }
            ?>
        </tbody>
    </table>
